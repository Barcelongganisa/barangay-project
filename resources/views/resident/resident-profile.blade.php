        ...
        <div class="card-body">
            <div class="row align-items-center">
                <div class="col-md-3 text-center mb-4 mb-md-0">
                    ...
                    >
                    <div class="mt-3">
                        <form id="profile-photo-form" action="{{ route('resident.profile-photo.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('patch')

                            <!-- Hidden file input -->
                            <input type="file" id="profile-photo" name="profile_photo" class="d-none" accept="image/*" onchange="document.getElementById('profile-photo-form').submit();">

                            <!-- Button triggers the file input -->
                            <button type="button" class="btn btn-sm btn-outline-primary" onclick="document.getElementById('profile-photo').click()">
